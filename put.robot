...
Post_CriandoUsuario
    ...
    ${response}=  Put On Session   mysession  ${endpoint}  data={"name": "Carolina Teste api robotframework","email": "teste123@teste.com","gender": "male","status": "active"}  headers=${headers}
